...
export default function UserModal({ onClose }: { onClose: () => void }) {
	...
	const handleGithub = () => {
		window.open("https://github.com/hkgame01/", "_blank");
	};
	...
	return (
		...
		>
			...
			<div className="p-4 border-b dark:border-gray-600 flex items-center">
				...
				{isLoading ? (
					<div className="mt-2">
						...
						<div className="dark:bg-neutral-700 bg-gray-100 animate-pulse h-3 w-32 rounded"></div>
					</div>
				) : (
					<div>
			...
			<div className="py-1">
				...
				<button className="w-full flex items-center px-4 py-2 text-gray-400 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600">
