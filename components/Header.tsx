...
import { ChevronDown, PlusIcon, Sparkles } from "lucide-react";
...
const BrainlyProBadge = ({ className = "" }: { className?: string }) => (
	<div
	...
	>
		...
		<span className="mr-1">Innota Pro</span>
	</div>
);
...
export default function Header({
	...
	useEffect(() => {
		const getUserData = async () => {
			...
			setIsPro(userDetails?.isPremium || false);
		};
		getUserData();
	}, []);
